...
export async function generateMovieTitles(query, temperature, apiKey, preferredModel = 'gemini-3.1-flash-lite') {
...
export function getGeminiErrorResponse(err) {
  ...
  return { status: 500, body: { error: 'Proxy request failed', details } };
}
